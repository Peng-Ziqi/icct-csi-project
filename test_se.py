...
def main():
    ...
    log_path = os.path.join(args.log_dir, f"test_se_cr{args.cr}.log")
    ...
    model = SECsiNet(h, w, args.cr, se_reduction=args.se_reduction).to(args.device)
    ckpt = f"checkpoints/se_csinet_cr{args.cr}.pt"
